---
title: "01_PEMprepr"
subtitle: "Prepare basedata for stude area"
author: "G. Perkins"
date: "2023-06-19"
...
aoi_raw <- st_read(file.path(project_name, "00_raw_inputs", "10_vector", "aoi.gpkg"))
...
sf::st_write(aoi, file.path(fid$shape_dir_1010[1], "aoi_snapped.gpkg"), append = FALSE)

```


# Collection of vector data from BC Data catalogue
...
#dem <- terra::rast("D:/GitHub/PEM_Methods_DevX/BaboonProcess_AOI/00_raw_inputs/20_dem/lidar/dem.tif")
#dem <- system.file("extdata", "dem.tif",package = "PEMprepr")
dem <- terra::rast(file.path(fid$lidar_dir_00, "dem.tif"))
terra::plot(dem)
...
create_covariates(dtm = file.path(fid$lidar_dir_00, "dem.tif"),           ## raster created above
                  SAGApath = "C:/saga-9.0.2_x64/", ## Where SAGA GIS is installed
