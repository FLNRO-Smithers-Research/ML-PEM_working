...
#create_covariates <- function(saga_dir,  saga_files, cov_type) {
  ...
  #      saga_files = "E:/temp/PEM_DATA/BEC_DevExchange_Work/Deception-AOI/1_map_inputs/covariates/25m"
        
saga_dir = "C:/SAGA/saga-7.7.0_x64"
#saga_files = "D:/PEM_DATA/BEC_DevExchange_Work/Deception_AOI/1_map_inputs/covariates/25m"
saga_files = "D:/PEM_DATA/BEC_DevExchange_Work/DateCreek_AOI/1_map_inputs/covariates/25m"
...
dem_template <- raster(file.path(saga_files,"dem.tif"))
...
# Tested  csiveing with coding vs QGIS but not very good. 
...
files_to_crop <- c("dah_LS.tif", "mrvbf_LSs.tif", "landform_LSs.tif")

rtemplate <- raster(file.path(saga_files,"dem.tif"))
...
# write out raster
writeRaster(r, file.path(saga_files, "landscape_variable_validation.tif" ), overwrite = TRUE)
